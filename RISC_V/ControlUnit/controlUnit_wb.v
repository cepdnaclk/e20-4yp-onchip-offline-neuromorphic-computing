// =============================================================================
// controlUnit_wb.v — Control Unit with safe DEFAULT case for Wishbone CPU
// =============================================================================
// Based on controlUnit.v — adds a default case that sets all control outputs
// to safe values (0) for unrecognized opcodes. This prevents X propagation
// into Wishbone bus logic.
// =============================================================================

module controlUnit_wb(INSTRUCTION,WRITE_ENABLE,MEMORY_ACCESS,MEM_WRITE,MEM_READ,JUMP_AND_LINK,ALU_OPCODE,IMMEDIATE_SELECT,OFFSET_GENARATOR,BRANCH,JUMP,IMMEDIATE_TYPE);
...
always @(OPCODE,FUNCT3,FUNCT7) begin
    ...
    // =====================================================================
    // DEFAULT: Safe NOP — all control signals set to 0
    // This prevents X propagation for unrecognized opcodes (e.g. 0x00000000)
    // =====================================================================
    default: begin
        IMMEDIATE_TYPE = 3'b000;
        WRITE_ENABLE = 1'b0;
